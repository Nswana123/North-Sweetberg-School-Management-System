                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('target') is-invalid @enderror" 
                                    ...
                                    <option value="staff" {{ old('target', $announcement->target) == 'staff' ? 'selected' : '' }}>Staff Only</option>
                                    <option value="faculty" {{ old('target', $announcement->target) == 'faculty' ? 'selected' : '' }}>Faculty Only</option>
                                </select>
                                @error('target')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
