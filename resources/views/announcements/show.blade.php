 ...
 <div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <div class="mb-4">
                <p class="text-muted">
                    <i class="fas fa-user"></i> Posted by: {{ $announcement->user->name }}<br>
                    <i class="fas fa-calendar"></i> Active from: {{ $announcement->start_date->format('M d, Y') }} to {{ $announcement->end_date->format('M d, Y') }}<br>
                    <i class="fas fa-users"></i> Target: {{ ucfirst($announcement->target) }}
                </p>
            </div>
        ...
        <div class="card-footer d-flex justify-content-end">
            ...
            <a href="{{ route('announcements.edit', $announcement) }}" class="btn btn-primary me-2">
