...
@endif 
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <div class="header-title">
            <h5 class="mb-0">
                Programs
                <span class="badge bg-primary">{{ $programs->total() }}</span>
            </h5>
        </div>
            ...
            <tbody>
                @forelse ($programs as $index => $program)
                    <tr class="table-row" style="animation-delay: {{ $index * 0.05 }}s">
                        <td>{{ $program->name }}</td>
                        <td class="code-cell">{{ $program->program_code }}</td>
                        <td>{{ $program->department->name ?? 'N/A' }}</td>
                        <td>
                            <a href="{{ route('programs.show', $program->id) }}" class="btn btn-info btn-sm">More</a>
                        </td>
                    </tr>
                @empty
                    <tr class="table-row">
