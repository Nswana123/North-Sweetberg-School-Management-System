...
@endif 
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <div class="header-title">
            <h5 class="mb-0">
                Departments
                <span class="badge bg-primary">{{ $departments->total() }}</span>
            </h5>
        </div>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <form action="{{ route('departments.destroy', $department->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button onclick="return confirm('Are you sure you want to delete this department?')" class="btn btn-danger btn-sm">Delete</button>
                                </form>
                            </div>
                        </td>
                    </tr>
