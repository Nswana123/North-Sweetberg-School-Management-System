...
@endif 
 ...
 <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div>
        <form method="GET" action="{{ route('enrollment.PendingEnrollment') }}" class="row g-2 align-items-center">
            <div class="col-auto">
            ...
            <div class="col-auto">
                ...
                @if(request('start_date') || request('end_date'))
                    <a href="{{ route('enrollment.PendingEnrollment') }}" class="btn btn-sm btn-outline-secondary">Clear</a>
                @endif
            </div>
        </form>
    </div>
        ...
        <tbody>
            @foreach($admissions as $admission)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('enrollment.showPendingEnrollment', $admission->id) }}" class="btn btn-sm btn-primary">View</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
