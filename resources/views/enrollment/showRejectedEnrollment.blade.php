...
@endif
    ...
    <ul class="list-group mb-4">
        ...
        <li class="list-group-item"><strong>Duration:</strong> {{ $admission->program->duration }} years</li>
         <li class="list-group-item"><strong>Admission Rejected at:</strong> {{ $admission->updated_at }}</li>
          <li class="list-group-item"><strong>Rejected Comment:</strong> {{ $admission->rejected_comment }}</li>
    </ul>
    ...
    <div class="mt-4">
        ...
        <a href="{{ route('enrollment.rejectedEnrollment') }}" class="btn btn-secondary float-end">Back to List</a>
    </div>
    </div>
    </div>
</div>
